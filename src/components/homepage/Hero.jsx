    ...
    <section id="hero" className="hero relative flex w-full h-screen select-none items-center justify-center" aria-label="hero">
      <div className="z-10 flex flex-col  w-full items-center text-title 2xl:text-[10vw] 2xl:space-y-16 font-bold  uppercase text-accent-300">
        <div className="title 2xl:py-6">
          <h1 ref={(el) => (titles.current[0] = el)} className="translate-y-96 font-outline-3 md:font-outline-4 text-transparent overflow-visible">
            Hey there, I&apos;m
          </h1>
        </div>
        <div className=" title 1xl:py-0">
        <h1 ref={(el) => (titles.current[1] = el)} className="translate-y-96">
            Suman Thakur
          </h1>
        </div>
        <div className=" title 2xl:py-6">
          <h1 ref={(el) => (titles.current[2] = el)} className="translate-y-96 font-outline-3 md:font-outline-4 text-transparent overflow-visible">
            Coder & Designer
          </h1>
        </div>
      </div>
      ...
      >
        <img
          ref={img}
          className="scale-100 rounded-full opacity-100 w-[100%] h-auto"
          src={heroImg}
          alt="Abstract circle background image."
        />
      </div>
